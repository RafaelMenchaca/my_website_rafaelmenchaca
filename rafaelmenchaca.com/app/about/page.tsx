  ...
  return (
    <main className="px-6 py-24 max-w-4xl mx-auto">
      ...
      <p className="mt-6 text-lg text-gray-600">
        I&apos;m a backend-focused developer interested in building reliable systems and
        implementing AI in practical, real-world applications.
      </p>

      <p className="mt-4 text-gray-600">
        While I work across the stack, my main focus is on backend logic, data
        modeling, API design, and AI-powered workflows. Frontend is a tool for
        delivering well-structured systems, not the end goal.
      </p>

      <p className="mt-4 text-gray-600">
        I&apos;m currently developing <strong>Educativo IA</strong>, an AI-powered
        educational platform. This project has allowed me to work on backend
      ...
      <h2 className="mt-12 text-2xl font-semibold">How I think as a developer</h2>
